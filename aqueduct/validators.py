...
def validate_wra_params(func):
    ...
    def wrapper(*args, **kwargs):
        validation_schema = {
            "wscheme": {"required": True},
            "geostore": {"type": "string", "required": True},
            "analysis_type": {"type": "string", "required": True, "default": None},
            "month": {"required": False, "default": None, "nullable": True},
            "year": {
                "type": "string",
                "required": False,
                "default": None,
        ...
        if request.method == "POST":
            jsonRequestContent = request.get_json()
...
def validate_params_risk(func):
    ...
    def wrapper(*args, **kwargs):
        validation_schema = {
            ...
            "exposure": {"type": "string", "required": True, "coerce": to_lower},
            "flood": {"type": "string", "required": True, "coerce": to_lower},
        }
